  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50" dir="rtl">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-700 font-medium max-w-2xl mx-auto leading-relaxed">
            اكتشف تشكيلة متنوعة من الخدمات عالية الجودة
          </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {categories.map((category, index) => (
                <div key={category.id} className="relative group">
                  <Link to={`/service/${createServiceSlug(category.name || category.name)}`}>
                    <div className="bg-white rounded-2xl overflow-hidden border border-pink-200/60 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                      ...
                      <div className="p-6 text-center">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed mb-4 line-clamp-2">
                          {category.description || 'اكتشف مجموعة متنوعة من الخدمات عالية الجودة'}
                        </p>
      ...
      <section className="relative py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">أحدث الخدمات</h2>
            <div className="h-1 bg-gradient-to-r from-pink-400 via-rose-500 to-pink-400 rounded-full mb-6 mx-auto w-32 shadow-lg" />
            <p className="text-gray-600">اكتشف أحدث إضافاتنا من الخدمات المميزة</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="text-center md:text-right">
              <h3 className="text-xl font-bold mb-4">UfuqDigital</h3>
              <p className="text-gray-300">
                متجرك المفضل لأفضل الخدمات بجودة عالية وتصميم فاخر
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/products" className="text-gray-300 hover:text-white transition-colors">الخدمات</Link></li>
            ...
            <div className="text-center md:text-left">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-300">✉️ info@UfuqDigital.</p>
