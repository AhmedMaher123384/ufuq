...
import { RefreshCw, ChevronDown, Send, CheckCircle, Copy } from 'lucide-react';
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <Section title="معلومات إضافية (اختياري)">
        <FormTextarea control={control} name="extraInfo" placeholder="أي تفاصيل تساعدنا في فهم مشروعك..." />
      </Section>
      ...
      <div className="max-w-6xl mx-auto px-4 pt-[90px] lg:pt-[140px] pb-20">
        ...
        <div className="hidden lg:grid grid-cols-2 gap-12 items-center mb-14">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base text-[#8F93A5]/80">املأ النموذج وسيتواصل معك فريقنا خلال دقائق</p>
          </div>
        </div>
