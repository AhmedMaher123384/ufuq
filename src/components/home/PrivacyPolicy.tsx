  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a] relative overflow-hidden" dir="rtl">
      ...
      <div className="absolute inset-0 opacity-25">
        ...
        <div className="absolute bottom-20 right-20 w-48 h-48 bg-[#24a67b]/10 rounded-full blur-3xl animate-pulse animate-pulse-delay-1"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 lg:py-12 mt-[70px] sm:mt-[80px]">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-20 animate-scaleIn">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div className="relative w-12 h-12 sm:w-16 sm:h-16 group animate-float">
              <div className="absolute -inset-2 bg-gradient-to-br from-[#7a7a7a]/40 to-[#24a67b]/30 blur-sm transform rotate-0 transition-all duration-500 group-hover:scale-110 animate-glow"
                   style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
              </div>
              <div className="absolute inset-0 bg-gradient-to-br from-[#7a7a7a]/30 to-[#24a67b]/30 backdrop-blur-md border border-[#7a7a7a]/40 transform rotate-0 transition-all duration-500 group-hover:scale-110"
                   style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
              </div>
            ...
            <div className="relative w-12 h-12 sm:w-16 sm:h-16 group animate-float hidden sm:block">
              <div className="absolute -inset-2 bg-gradient-to-br from-[#24a67b]/30 to-[#7a7a7a]/40 blur-sm transform rotate-0 transition-all duration-500 group-hover:scale-110 animate-glow"
                   style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Shield className="w-6 h-6 sm:w-8 sm:h-8 text-[#24a67b] filter drop-shadow-[0_0_12px_rgba(24,181,213,0.9)]" />
              </div>
            </div>
          </div>
          <div className="bg-gradient-to-br from-[#16161B]/95 via-[#7a7a7a]/30 to-[#16161B]/90 rounded-xl sm:rounded-2xl backdrop-blur-xl border border-white/15 p-3 sm:p-4 max-w-xs sm:max-w-2xl mx-auto animate-slideInRight mobile-padding ultra-mobile-padding">
            <div className="flex items-center gap-2 justify-center flex-wrap">
              <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-[#24a67b]" />
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-[#16161B]/95 via-[#7a7a7a]/30 to-[#16161B]/90 rounded-2xl sm:rounded-3xl backdrop-blur-xl border border-white/15 shadow-2xl p-4 sm:p-6 lg:p-8 xl:p-12 mobile-padding ultra-mobile-padding">
            {/* Introduction */}
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#24a67b] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
              ...
              <div className="mb-4 sm:mb-6">
                <h3 className="text-lg sm:text-xl font-bold text-[#24a67b] mb-3 sm:mb-4">{t('privacy_policy.data_collection.subtitle')}</h3>
              ...
              <div className="mb-4 sm:mb-6">
                <h3 className="text-lg sm:text-xl font-bold text-[#24a67b] mb-3 sm:mb-4">{t('privacy_policy.data_usage.subtitle')}</h3>
                <div className="space-y-2 sm:space-y-3">
                  {[
                    ...
                    <div
                      ...
                      style={{ animationDelay: `${index * 0.1}s` }}
                    >
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#24a67b] flex-shrink-0" />
              ...
              <div className="space-y-2 sm:space-y-3">
                {[
                  ...
                  <div
                    ...
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-[#24a67b] flex-shrink-0" />
                    <span className="text-gray-100 text-sm sm:text-base">{item}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-[#7a7a7a]/15 border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 animate-scaleIn mobile-padding ultra-mobile-padding hover-lift">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <a
                    ...
                    dir="ltr"
                  >
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-[#24a67b]/12 via-transparent to-transparent" />
                    <div className="relative flex items-start gap-3">
                      <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-[#24a67b]/15 border border-white/10 flex items-center justify-center flex-shrink-0">
                        <Mail className="w-5 h-5 text-[#24a67b]" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="text-xs sm:text-sm font-semibold text-gray-100/90">
                          {t('privacy_policy.contact.email_label')}
                        </div>
                  ...
                  >
                    ...
                    <div className="relative flex items-start gap-3">
                      <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-[#24a67b]/15 border border-white/10 flex items-center justify-center flex-shrink-0">
                        <Phone className="w-5 h-5 text-[#24a67b]" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="text-xs sm:text-sm font-semibold text-gray-100/90">
