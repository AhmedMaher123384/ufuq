...
const ProductCard: React.FC<ProductCardProps> = ({ product, viewMode = 'grid' }) => {
  ...
  const gradients = [
    'from-[#16161B]/95 via-[#18b5d8]/20 to-[#16161B]/90',
    'from-[#16161B]/90 via-[#18b5d8]/15 to-[#16161B]/95',
    'from-[#16161B]/93 via-[#18b5d8]/25 to-[#16161B]/88'
  ];
  ...
  if (viewMode === 'list') {
    return (
      <Link
        ...
        className="relative group block bg-gradient-to-br from-[#16161B]/95 via-[#7a7a7a]/30 to-[#16161B]/90 rounded-2xl backdrop-blur-xl border border-white/10 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] w-full overflow-hidden"
      ...
      >
        ...
        <div className="flex items-center p-6 gap-6">
          ...
          <div className="flex-shrink-0 flex flex-col items-end gap-3">
            <button
              className={`w-8 h-8 rounded-full bg-gradient-to-r from-[#18b5d8]/20 to-[#0d8aa3]/20 backdrop-blur-sm border border-[#18b5d8]/40 flex items-center justify-center transition-all duration-200 hover:scale-110 ${isInWishlist ? 'text-red-500 border-red-500/40' : 'text-white'
                }`}
              type="button"
    ...
    >
      ...
      <div className="relative p-8 text-center">
        ...
        <div className="absolute top-4 right-4 z-50">
          <button
            className={`w-10 h-10 rounded-full bg-gradient-to-r from-[#18b5d8]/20 to-[#0d8aa3]/20 backdrop-blur-sm border border-[#18b5d8]/40 flex items-center justify-center transition-all duration-200 hover:scale-110 ${isInWishlist ? 'text-red-500 border-red-500/40' : 'text-white'
              }`}
            type="button"
