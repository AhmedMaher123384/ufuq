...
const ThankYou: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#16161B] flex items-center justify-center px-4">
  ...
  return (
    <div className="min-h-screen bg-[#16161B] relative overflow-hidden" dir="rtl">
      {/* Celebration Effects */}
      {celebrationActive && (
        <>
          {/* Floating particles */}
      ...
      <div className="relative bg-gradient-to-br from-[#16161B] via-[#1a1a1a] to-[#0f0f0f] border-b border-[#18b5d8]/30">
...
<div className="bg-white/5 backdrop-blur-2xl rounded-2xl sm:rounded-3xl shadow-2xl border border-white/20 p-4 sm:p-8">
  ...
  {/* زر الاتصال */}
  <button
    onClick={() => (window.location.href = "tel:+966543098895")}
  ...
  {/* زر واتساب */}
  <button
    onClick={() => window.open("https://wa.me/966543098895", "_blank")}
    className="w-full bg-white/10 hover:bg-white/20 text-white px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl 
               transition-all duration-300 font-bold border border-white/20 
               hover:border-white/40 flex items-center justify-center text-sm sm:text-base"
  >
