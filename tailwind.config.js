...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        'sans': ['Cairo', 'PingARLT', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', 'sans-serif'],
      ...
      animation: {
        ...
        'pulse-subtle': 'pulse 4s infinite',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
